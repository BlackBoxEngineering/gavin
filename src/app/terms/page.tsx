        ...
        <div style={{ marginTop: "2rem", display: "grid", gap: "1.5rem", lineHeight: 1.8, color: "var(--text)" }}>
          <div>
            ...
            <p style={{ margin: 0, color: "var(--text-muted)" }}>
              gavinwoodhouse.com is the personal and professional profile site of Gavin
              Woodhouse. The site provides information about Gavin Woodhouse and the advisory
              services he offers.
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ margin: 0, color: "var(--text-muted)" }}>
              ...
              of Gavin Woodhouse and may not be reproduced, distributed, or used without prior
              written permission.
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ margin: 0, color: "var(--text-muted)" }}>
              To the fullest extent permitted by law, Gavin Woodhouse accepts no liability for
              any loss or damage arising from use of or reliance on the content of this site.
            </p>
          </div>
          ...
          <div>
            ...
            <p style={{ margin: 0, color: "var(--text-muted)" }}>
              This site may contain links to third-party websites. We have no control over the
          ...
          <div>
            ...
            <p style={{ margin: 0, color: "var(--text-muted)" }}>
              ...
              from use of this site are subject to the exclusive jurisdiction of the courts of
              England and Wales.
            </p>
          </div>
